...
Download the files (can be done as a zip file through code -> download zip, by cloning the repository, through GitHub desktop or individually downloading files)
